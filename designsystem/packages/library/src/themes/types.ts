...
export type IconColorType =
  ...
  | "inversedRemainsWhite"
  | "inversedChangeBlack"
  | "clubPerifitChangeWhite"
  | "clubPerifitRemainsBlack";

export type FillColorType =
  | "page"
  | "block"
  | "blockRemainsWhite"
  | "primary"
...
export type ButtonColorType =
  ...
  | "primaryTextDefault"
  | "primaryTextDisabled"
  | "secondaryFillDefault"
  | "secondaryFillHover"
  | "secondaryFillDisabled"
...
export type ObjectiveColorType =
  | "objective1Background"
  | "objective1Text"
  | "objective2Background"
  | "objective2Text"
  | "objective3Background"
  | "objective3Text"
  | "objective4Background"
  | "objective4Text"
  | "objective5Background"
  | "objective5Text"
  | "objective6Background"
  | "objective6Text";

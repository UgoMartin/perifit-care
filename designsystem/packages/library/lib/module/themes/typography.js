...
const getFontSize = size => normalize(size * fontRatio);
const geLineHeight = size => normalize(size * fontRatio);
export const getTypography = themeColors => StyleSheet.create({
  big: {
